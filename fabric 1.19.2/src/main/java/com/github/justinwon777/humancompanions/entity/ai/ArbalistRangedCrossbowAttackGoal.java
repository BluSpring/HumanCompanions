    ...
    public void tick() {
        ...
        if (livingentity != null) {
            ...
            if (this.crossbowState == ArbalistRangedCrossbowAttackGoal.CrossbowState.UNCHARGED) {
                if (!flag2) {
                    this.mob.startUsingItem(this.mob.getMainHandItem().getItem() instanceof CrossbowItem ? InteractionHand.MAIN_HAND : InteractionHand.OFF_HAND);
                ...
                if (this.mob.getTarget() != null) {
                    ...
                    ItemStack itemstack1 = this.mob.getItemInHand(this.mob.getMainHandItem().getItem() instanceof CrossbowItem ? InteractionHand.MAIN_HAND : InteractionHand.OFF_HAND);
